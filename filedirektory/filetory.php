...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>belajar-php-file-direktory</title>
				...
				<aside class="app-sidebar sidebar-scroll">
					<div class="main-sidemenu">
						...
						<ul class="side-menu ">
							...
							<li class="slide">
								<a class="side-menu__item" href="filetory.php"><i class="side-menu__icon fe fe-cpu"></i><span class="side-menu__label">filedirektory</span></a>
							</li>
							<li class="slide">
			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2">FILE DIREKTORY</h4>
						</div>
					</div>
					<!-- /breadcrumb -->
