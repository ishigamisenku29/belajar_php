...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>belajar-php-fungsi</title>
				...
				<aside class="app-sidebar sidebar-scroll">
					<div class="main-sidemenu">
						...
						<ul class="side-menu ">
							...
							<li class="slide">
								<a class="side-menu__item" href="newfungsi.php"><i class="side-menu__icon fe fe-layers "></i><span class="side-menu__label">fungsi</span></a>
							</li>
							<li class="slide">
			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2">fungsi</h4>
						</div>
					</div>
					<!-- /breadcrumb -->
                                    ...
                                    <div class="">
                                        ...
                                        <div class="fungsition">
                                            <?php
                                                ...
                                                familyName(" <pre> Jani </pre> ");
                                                familyName(" <pre> edo </pre> ");
                                                familyName(" <pre> doni </pre> ");
                                                familyName(" <pre> agil </pre> ");
                                                familyName(" <pre> reva </pre> ");
