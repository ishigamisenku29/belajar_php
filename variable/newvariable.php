...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>belajar-php-variable</title>
				...
				<aside class="app-sidebar sidebar-scroll">
					<div class="main-sidemenu">
						...
						<ul class="side-menu ">
							...
							<li class="slide">
								<a class="side-menu__item" href="newvariable.php"><i class="side-menu__icon fe fe-help-circle"></i><span class="side-menu__label">variable</span></a>
							</li>
						</ul>
			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2">VARIABLE</h4>
						</div>
					</div>
					<!-- /breadcrumb -->
								...
								<div class="card custom-card">
									<div class="card-body ht-100p">   
                                        <div class="pengertian">
                                            <h1>pengertian variable</h1>
                                            <p>Variabel adalah konsep penting dalam pemrograman PHP (dan dalam pemrograman secara umum). Mereka digunakan untuk menyimpan dan mengelola data yang akan digunakan dalam program.</p>
                                        </div>
                                        <!-- variable -->
                                            <div class="variable">
                                                <?php
