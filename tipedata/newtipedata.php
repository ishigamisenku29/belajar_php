...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>belajar-php-tipe-data</title>
				...
				<aside class="app-sidebar sidebar-scroll">
					<div class="main-sidemenu">
						...
						<ul class="side-menu ">
							...
							<li class="slide">
								<a class="side-menu__item" href="newtipedata.php"><i class="side-menu__icon fe fe-package"></i><span class="side-menu__label">tipe data</span></a>
							</li>
							<li class="slide">
			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2">TIPE DATA</h4>
						</div>
					</div>
					<!-- /breadcrumb -->
							...
							<!-- card na -->
								<div class="card custom-card">
									<div class="card-body ht-100p">   
                                         <!-- tipe data -->
                                            <!-- string -->
                                            <h4>tipe data bertipe string</h2>
                                            <div class="string">
                                                    <?php 
                                                        // $x = "1234";
                                                        // $y = 'Hello world!';
                                            ...
                                            <!-- integer/int -->
                                            <h4>tipe data bertipe integer/int</h4>
                                            <div class="integer">
                                                <?php  
                                                    // $x = 5985;
                                                    // var_dump($x);
                                            ...
                                            <!-- boolean -->
                                            <h4>tipe data bertipe boolean</h4>
                                            <div class="boolean">
                                                <?php
                                                    // $x = true;
                                                    // var_dump($x);
                                            ...
                                            <!-- resource -->
                                            <h4>tipe data bertipe resource</h4>
                                            <div class="resource">
                                                <?php
