...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>belajar-php-databases</title>
				...
				<aside class="app-sidebar sidebar-scroll">
					<div class="main-sidemenu">
						...
						<ul class="side-menu ">
							...
							<li class="slide">
								<a class="side-menu__item" href="newdatabases.php"><i class="side-menu__icon fe fe-database"></i><span class="side-menu__label">databases</span></a>
							</li>
							<li class="slide">
